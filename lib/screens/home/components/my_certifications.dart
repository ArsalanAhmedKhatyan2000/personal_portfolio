...
class MyCertifications extends StatelessWidget {
  const MyCertifications({Key? key}) : super(key: key);
            ...
            builder: TimelineTileBuilder.connectedFromStyle(
              ...
              contentsBuilder: (context, index) {
                return Padding(
                  ...
                  child: EducaionCard(education: demo_certifications[index]),
                );
              },
              oppositeContentsBuilder: (context, index) {
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "${demo_certifications[index].duration}",
